...
#if the result is greater than 10,000 then output caching will not work
...
function verify-spoutputcachelimit (
...
verify-spoutputcachelimit -url $url -execute $false